...
<div class="alert alert-danger">
    <strong>Hops!</strong> Je nějaký problém s Vaším vstupem.<br><br>
    <ul>
    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                <textarea class="form-control" style="height:150px" name="file" placeholder="Soubor"></textarea>
            </div>
        </div>
